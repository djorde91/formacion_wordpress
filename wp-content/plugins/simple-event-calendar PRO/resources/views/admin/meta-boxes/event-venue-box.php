...
<div class="new_venue_box event_block_edit">
    <table id="event_venue_info" class="event_venue_info">
        ...
        <tr class="venue_field">
            ...
            <td><input type="text" id="latitude" class="gd_calendar_map_coordinates" name="latitude"></td>
        </tr>
        <tr class="venue_field">
            <td><?php _e('Longitude', 'gd-calendar'); ?></td>
            <td><input type="text" id="longitude" class="gd_calendar_map_coordinates" name="longitude"></td>
        </tr>
        <tr class="venue_field">
            <td></td>
            <td>
