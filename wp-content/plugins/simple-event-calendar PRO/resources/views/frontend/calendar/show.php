 ...
 */
    ...
    $sidebar = $calendar->get_view_type_sidebar();
...
?>
    <div id="gd_calendar_wrapper_<?php echo $id; ?>" class="gd_calendar_wrapper gd_calendar_body gd_calendar_theme_<?php echo $theme;?>">
        ...
        if($sidebar === 'gd_calendar_view_type_sidebar' && !(count($views) === 1 && $year === true )){
        ?>
            <div class="gd_calendar_sidebar" data-calendar-id="<?php echo $id; ?>">
        <?php
            \GDCalendar\Helpers\View::render('frontend/calendar/sidebar.php', array(
                'sidebar_month' => $show,
            ));
        ?>
            </div>
