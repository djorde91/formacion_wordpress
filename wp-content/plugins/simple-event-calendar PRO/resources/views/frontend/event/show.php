...
<div class="event_view gd_calendar_body">
    ...
    <table id="event_gen_option" class="event_gen_option">
        ...
        <input id="latitude_view" type="hidden" value="<?php echo floatval($venue->get_latitude()); ?>">
        <input id="longitude_view" type="hidden" value="<?php echo floatval($venue->get_longitude()); ?>">
    </table>
    <?php $i = random_int(0, 10000); ?>
    <div id="map_view_<?php echo $i; ?>" class="map_view event_map">
    </div>
