...
Create as many [templates](https://kb.wprssaggregator.com/article/457-templates) as you need to display imported items in different ways across your site. Be it on the homepage, in a sidebar, or in the footer, you can specify which template to use and which sources to display in every specific area of your site.

Our [gutenberg block](https://kb.wprssaggregator.com/article/454-displaying-imported-items-block-gutenberg) ensures seamless integration with the latest versions of WordPress. Choose the template to use and the sources to display, then you're all set (plus a few other customisation options). If you are using the classic WordPress editor, we've got you covered. Click on the WP RSS Aggregator button in the TinyMCE editor to open our shortcode modal. It has all the same options as the block, ensuring that no functionality is lost no matter what you use.
...
== Premium add-ons to feed your imagination! ==

We offer multiple add-ons that can be purchased separately or as discounted bundles. Take a look at our **[Pricing Page](https://www.wprssaggregator.com/pricing/?utm_source=wordpress-dot-org&utm_medium=readme&utm_campaign=readme_pricing_link&utm_content=pricing_link)** to learn more about the premium offers available right now.

Import RSS feeds as WordPress Posts (or any other post type) with our **[Feed to Post](https://www.wprssaggregator.com/extension/feed-to-post/?utm_source=wordpress-dot-org&utm_medium=readme&utm_campaign=readme_f2p_link&utm_content=f2p_link)** add-on. Use your theme, a page builder, or a plugin such as Toolset to display the imported posts anywhere you want, just the way you want it.

The **[Full Text RSS Feeds](https://www.wprssaggregator.com/extension/full-text-rss-feeds/?utm_source=wordpress-dot-org&utm_medium=readme&utm_campaign=readme_ftr_link&utm_content=ftr_link)** add-on extends Feed to Post to bring in the full content from any source that limits the content it provides via RSS.

Here's a look at what these two add-ons can offer together:

[youtube https://www.youtube.com/watch?v=-2z_bNws2MM]

And here's a written list of the main features:
...
* **[Keyword Filtering](https://www.wprssaggregator.com/extension/keyword-filtering/?utm_source=wordpress-dot-org&utm_medium=readme&utm_campaign=readme_kf_link&utm_content=kf_link)** gives you the option of filtering through only the items you want. You can add filters based on keywords, phrases and/or tags.
* **[Excerpts & Thumbnails](https://www.wprssaggregator.com/extension/excerpts-thumbnails/?utm_source=wordpress-dot-org&utm_medium=readme&utm_campaign=readme_et_link&utm_content=et_link)** takes your shortcode display to the next level by adding images and excerpts, sprucing up your site and grabbing the attention of your readers.
* **[Source Categories](https://www.wprssaggregator.com/extension/categories/?utm_source=wordpress-dot-org&utm_medium=readme&utm_campaign=readme_cat_link&utm_content=cat_link)** gives you more control over how you organise the sources you are importing from. It's a simple tool that can go a long way to keeping track of multiple sources and source types.
